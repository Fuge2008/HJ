...
package com.haoji.haoji.video.record.camera.encoder.video;
...
//
//    public void setCameraView(MagicCameraView magicCameraView) {
//        mMagicCameraView = magicCameraView;
//    }
...
//        handleStartRecording((EncoderConfig) config);
    }
...
//                    DebugTool.warn("ImageCodeEnCoder:frameAvailable" + timestamp);
...
//        DebugTool.warn(TAG + ":handleStartRecording" + config);
...
//        DebugTool.warn(TAG + ",handleFrameAvailable tr=" + transform + "," + timestampNanos);
...
//        mVideoEncoder.drainEncoder(true);
    ...
    ImageEncoderCore.OnImageEncoderListener mOnImageEncoderListener;

    public void setOnImageEncoderListener(ImageEncoderCore.OnImageEncoderListener onImageEncoderListener) {
        mOnImageEncoderListener = onImageEncoderListener;
    }
//    Context mContext;
