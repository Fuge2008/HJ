...
//    }
    ...
    public void setFilter(final GPUImageFilter tempFilter){
        queueEvent(new Runnable() {
            @Override
            public void run() {
                if (filter != null)
    ...
    protected void adjustSize(int rotation, boolean flipHorizontal, boolean flipVertical){
        ...
        float[] cube = TextureRotationUtil.CUBE_BAAB;
        ...
        if(scaleType == ScaleType.CENTER_INSIDE){
            cube = new float[]{
                    TextureRotationUtil.CUBE_BAAB[0] / ratioHeight, TextureRotationUtil.CUBE_BAAB[1] / ratioWidth,
                    TextureRotationUtil.CUBE_BAAB[2] / ratioHeight, TextureRotationUtil.CUBE_BAAB[3] / ratioWidth,
                    TextureRotationUtil.CUBE_BAAB[4] / ratioHeight, TextureRotationUtil.CUBE_BAAB[5] / ratioWidth,
                    TextureRotationUtil.CUBE_BAAB[6] / ratioHeight, TextureRotationUtil.CUBE_BAAB[7] / ratioWidth,
            };
