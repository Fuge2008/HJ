...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int selectedTabTextSize = 24;
    ...
    private int tabBackgroundResId = R.color.colorWhite;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //下面4个扩展的属性
        tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabTextColor, tabTextSize);
    ...
    public void setSelectedTextSize(int setSelectedTextSize) {
        this.selectedTabTextSize = setSelectedTextSize;
        updateTabStyles();
    }
