//package com.zhulei.haoji.custom;
//
...
//            if (attrIndex == R.styleable.DraggableFlagView_color9) {
...
//
//            maxMoveLength = SizeUtils.getDeviceHeight(context) / 6;
//
//            refreshStartPoint();
//
...
//        try {
//            location[1] = location[1] - SizeUtils.getTopBarHeight((Activity) context);
//        } catch (Exception ex) {
//        }
//
...
//            float maxRadius = SizeUtils.dp2px(context, 2);
