...
import com.haoji.haoji.download.core.app.BaseActivity2;
import com.haoji.haoji.download.layout.fragment.HistoryFragment;
import com.haoji.haoji.download.layout.fragment.VideoFragment;
import com.haoji.haoji.download.layout.fragment.VideoSearchFragment;
import com.haoji.haoji.download.util.content.Recv;
...
//                Toast.makeText(DownloadActivity.this,"Why?", Toast.LENGTH_SHORT).show();
//            }
//        });
    ...
    public void onBackPressed() {
        ...
        if (fm.getBackStackEntryCount() == 0 && !fromSend) {
            if (backPressAt == null || new Date().getTime() - backPressAt.getTime() > 2000) {
                ...
                com.haoji.haoji.download.core.app.Process.background(this);
                //super.onBackPressed();
                return;
            }
        }
