package com.haoji.haoji.download.util.io;

import android.support.annotation.NonNull;


import com.haoji.haoji.app.MyApplication;
import com.haoji.haoji.download.core.io.Storage;
import com.haoji.haoji.download.core.security.Encrypt;
...
public final class FileStorage extends File {
    ...
    public static final class Builder
    {
        ...
        {
            path = Storage.getCacheDir(MyApplication.getAppContext(), getRelativePath());
            return this;
        }
